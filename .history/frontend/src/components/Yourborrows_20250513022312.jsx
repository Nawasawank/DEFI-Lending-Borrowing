        ...
        <div className="borrows">
          <div className="borrows-header">
            ...
            <div className="info-sectionb">
              {loading ? (
                <>
                  <div className="info-boxb"><div className="skeleton shimmer" style={{ width: '80px', height: '20px' }} /></div>
                  <div className="info-boxb"><div className="skeleton shimmer" style={{ width: '100px', height: '20px' }} /></div>
                </>
              ) : (
                <>
