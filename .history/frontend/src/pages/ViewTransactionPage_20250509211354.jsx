        ...
        <div className="transaction-header">
          ...
          <div className="filters">
            ...
            <div className="amount-block">
              <input type="number" name="minAmount" placeholder="Min Amount" value={filters.minAmount} onChange={handleFilterChange} className="filter-input" />
              <input type="number" name="maxAmount" placeholder="Max Amount" value={filters.maxAmount} onChange={handleFilterChange} className="filter-input" />
            </div>
